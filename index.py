...
def upload(language):
	...
	if element.startswith("@"):
		...
		if element_s[1] == "elokapina.fi":
			...
			client = MatrixClient("https://matrix.elokapina.fi", token="syt_dGVrc3RpdHlrc2V0_ktlhkvqpXHHbSTnKgLtD_4gd6M0", user_id="@tekstitykset:elokapina.fi")
			nc = nextcloud_client.Client('https://cloud.elokapina.fi/')
			nc.login('tekstitykset', 'TekstityksetOVATparhaita')
